    ...
    <div className="min-h-screen bg-gray-50/50 pb-20 font-inter">
          ...
          <div className="flex items-center gap-4 bg-gray-50 p-1.5 rounded-xl border border-gray-200">
            {['Journalier', 'Hebdo', 'Mensuel', 'Annuel'].map(t => (
              <button
                ...
                className={`px-5 py-2.5 rounded-lg text-sm font-bold transition-all ${timeRange === t
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 space-y-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          {/* Main Chart Card */}
          <div className="xl:col-span-2 bg-white rounded-[24px] p-8 shadow-xl shadow-gray-100 border border-gray-100">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Performance Financière</h3>
                <p className="text-gray-400 font-medium mt-1">Flux de trésorerie sur 6 mois</p>
              </div>
              <button className="bg-gray-50 hover:bg-gray-100 p-2 rounded-xl transition-colors">
